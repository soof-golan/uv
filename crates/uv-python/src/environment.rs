...
impl fmt::Display for EnvironmentNotFound {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        impl fmt::Display for SearchType {
            fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
                match self {
                    ...
                    Self::System => write!(f, "system environment"),
                    Self::VirtualOrSystem => write!(f, "virtual or system environment"),
                }
            }
        }
        ...
        match search_type {
            ...
            SearchType::VirtualOrSystem => write!(f, "; run `{}` to create an environment, or `{}` to install Python", "uv venv".green(), "uv python install".green())?,
            SearchType::System => write!(f, "; run `{}` to install Python", "uv python install".green())?,
        }
